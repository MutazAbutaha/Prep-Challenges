...
for(let i=0; i<splitArr.length; i++){
  if(splitArr[0]=="I" && splitArr[1]=='was'){
    splitArr.splice(str.indexOf('I', 'was'), 2, 'We', 'were');
    outPut= splitArr.join(' ');
    return outPut
  }else if(splitArr[0]=='I' && splitArr[1]=='am'){
    splitArr.splice(str.indexOf('I', 'am'), 2, 'We', 'are');
    outPut = splitArr.join(' ');
    return outPut
  }else if(splitArr[0]=='I'){
    splitArr.splice(str.indexOf('I'), 1, 'We');
    outPut = splitArr.join(' ');
    return outPut
  }
}
